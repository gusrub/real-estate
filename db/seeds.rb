...
User.create first_name: "John", last_name: "Wayne", email: "john@example.com", password: "testing", role: User.roles[:admin], status: User.statuses[:active]
